    ...
    >
      <div style={customStyles.oVvirF}>
        <div style={customStyles.wwktUN}>
          <div>
            <div style={customStyles.ZFh3Ru}>Thanh toán thành công</div>
          </div>
        </div>
        <div style={customStyles.W6qz3v}>
          <Link to={"/home"} style={customStyles.nU2wV3} >Về Trang Chủ</Link>
          <Link to={"/user/purchase"} style={customStyles.ukVXpA} >Chi tiết đơn hàng</Link>
        </div>
      </div>
    </Modal>
  );
